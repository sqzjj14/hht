...
@interface MobileRegisterViewController3 ()
...
- (IBAction) mobileRegister:(id)sender {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0),
                   ^{
                       ...
                       NSString *content = [client get:[BASE_URL stringByAppendingFormat:@"/api/mobile/member!mobileRegister.do?mobile=%@&mobilecode=%@&password=%@",
