...
@interface MobileRegisterViewController2 ()
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0),
                   ^{
                       ...
                       dispatch_async(dispatch_get_main_queue(), ^{
                           ...
                           MobileRegisterViewController3 *mobileRegisterViewController3 = (MobileRegisterViewController3 *)[super controllerFromMainStroryBoard:@"MobileRegister3"];
                           mobileRegisterViewController3.mobile = mobile;
                           mobileRegisterViewController3.mobileCode = mobileCode.text;
