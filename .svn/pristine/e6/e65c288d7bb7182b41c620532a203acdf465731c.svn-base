...
@interface FindPassViewController1 ()
...
- (IBAction)next:(id)sender {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0),
                   ^{
                       ...
                       NSString *content = [client get:[BASE_URL stringByAppendingFormat:@"/api/mobile/member!sendFindPassCode.do?mobile=%@",
                                                        mobile.text]];
                       dispatch_async(dispatch_get_main_queue(), ^{
                           ...
                           FindPassViewController2 *findPassViewController2 = (FindPassViewController2 *)[super controllerFromMainStroryBoard:@"FindPass2"];
                           findPassViewController2.mobile = mobile.text;
